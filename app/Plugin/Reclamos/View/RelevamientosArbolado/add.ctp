...
<div class="row" id='poda' >
    <div class="col-md-12">
<?php echo $this->Template->drawBlockById("1"); ?>
    </div>
</div>
<div class="row" id='reparacion'>
    <div class="col-md-12">
<?php echo $this->Template->drawBlockById("2"); ?>
    </div>
</div>
<div class="row" id='extraccion'>
    <div class="col-md-12">
<?php echo $this->Template->drawBlockById("3"); ?>
    </div>
</div>
<div class="row" id='plantacion'>
    <div class="col-md-12">
<?php echo $this->Template->drawBlockById("4"); ?>
    </div>
</div>
